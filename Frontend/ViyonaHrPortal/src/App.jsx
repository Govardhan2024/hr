...
const App = () => {
  ...
  const hideNavbarEmployeeRoute=['/employee/Employeesidebar','/employee/dashboard',
    '/employee/Employeeholidays','/employee/EmployeEvents',
    '/employee/EmployeActivites','/employee/TotalEmployes','/employee/EmployeLeaves',
    '/employee/EmployeAttendence','/employee/Employedepartment',
    '/employee/EmpolyePayments','/employee/EmployeExpenses','/employee/EmployeInvoices',
    '/employee/EmployePayslip','/employee/EmployeEmployesalary','/employee/reports','/employee/profile'];
  ...
  return (
    <div className="app-container">
      ...
      {hideNavbarEmployeeRoute.includes(location.pathname) && <Employeesidebar/>} 
      ...
      <div className="main-content">
        <Routes>
          ...
          <Route path='/employee/Employeeholidays' element={<ProtectedRoute element={<Employeeholidays />} requiredRole="employee" />} />
          <Route path='/employee/EmployeEvents' element={<ProtectedRoute element={<EmployeEvents />} requiredRole="employee" />} />
          <Route path='/employee/EmployeActivites' element={<ProtectedRoute element={<EmployeActivites />} requiredRole="employee" />} />
          <Route path='/employee/TotalEmployes' element={<ProtectedRoute element={<TotalEmployes />} requiredRole="employee" />} />
          <Route path='/employee/EmployeLeaves' element={<ProtectedRoute element={<EmployeLeaves />} requiredRole="employee" />} />
          <Route path='/employee/EmployeAttendence' element={<ProtectedRoute element={<EmployeAttendence />} requiredRole="employee" />} />
          <Route path='/employee/Employedepartment' element={<ProtectedRoute element={<Employedepartment />} requiredRole="employee" />} />
          <Route path='/employee/EmpolyePayments' element={<ProtectedRoute element={<EmpolyePayments />} requiredRole="employee" />} />
          <Route path='/employee/EmployeExpenses' element={<ProtectedRoute element={<EmployeExpenses />} requiredRole="employee" />} />
          <Route path='/employee/EmployeInvoices' element={<ProtectedRoute element={< EmployeInvoices />} requiredRole="employee" />} />
          <Route path='/employee/EmployePayslip' element={<ProtectedRoute element={< EmployePayslip />} requiredRole="employee" />} />
          <Route path='/employee/EmployeEmployesalary' element={<ProtectedRoute element={< EmployeEmployesalary />} requiredRole="employee" />} />
        </Routes>
      </div>
    </div>
  );
